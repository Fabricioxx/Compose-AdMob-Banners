    ...
    nativeAd?.let { ad ->
        AndroidView(
            factory = { context ->
                ...
                val adView = inflater.inflate(R.layout.admob, null) as NativeAdView
                populateNativeAdView3(ad, adView)
                adView
            },
            modifier = Modifier
                .fillMaxWidth()
...
fun populateNativeAdView3(nativeAd: NativeAd, adView: NativeAdView) {
