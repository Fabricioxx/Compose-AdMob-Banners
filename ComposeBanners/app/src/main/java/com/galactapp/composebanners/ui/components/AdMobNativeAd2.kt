    ...
    nativeAd?.let { ad ->
        AndroidView(
            factory = { context ->
                ...
                val adView = inflater.inflate(R.layout.ad_adunified, null) as NativeAdView
...
fun populateNativeAdView2(nativeAd: NativeAd, adView: NativeAdView) {
    ...
    adView.advertiserView?.let {
        ...
        it.visibility = if (nativeAd.advertiser != null) View.VISIBLE else View.INVISIBLE
    }
